import"./assets/support-sidebar-d6b95525.js";const l=[{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"},{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"},{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"}];localStorage.setItem("localCard",JSON.stringify(l));const o="localCard",t=document.querySelector(".js-shopping-list"),a=r(o);a[0]!==void 0?(t.innerHTML="",t.insertAdjacentHTML("afterbegin",n(a)),t.addEventListener("click",c)):d();function c(s){if(s.target.nodeName==="BUTTON"||s.target.nodeName==="svg"||s.target.nodeName==="use")t.innerHTML="",a.splice(s.target.id,1),localStorage.removeItem(o),g(o,a),a[0]!==void 0?t.insertAdjacentHTML("afterbegin",n(r(o))):d();else return}function n(s){return s.map(({sebel:e},i)=>`<li class="shopping-list-item">

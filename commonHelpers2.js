import"./assets/support-sidebar-d6b95525.js";const a="localCard",t=document.querySelector(".js-shopping-list"),o=l(a);o[0]!==void 0?(t.innerHTML="",t.insertAdjacentHTML("afterbegin",n(o)),document.querySelector(".btnDelet"),t.addEventListener("click",c)):r();t.insertAdjacentHTML("afterbegin",`<svg class="shopping-list-card-icon-trash" width="12px" height="12px">
